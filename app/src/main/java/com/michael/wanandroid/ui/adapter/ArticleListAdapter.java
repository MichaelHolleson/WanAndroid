package com.michael.wanandroid.ui.adapter;
...
public class ArticleListAdapter extends RecyclerView.Adapter<ArticleListAdapter.ArticleListViewHolder> {
    ...
    private List<ArticleListResp.DataBean.ArticleBean> mArticleBeans;

    public ArticleListAdapter(Context context) {
        mContext = context;
    }

    public void setArticleBeans(List<ArticleListResp.DataBean.ArticleBean> articleBeans) {
    ...
    public void onBindViewHolder(@NonNull ArticleListViewHolder articleListViewHolder, int i) {
        ArticleListResp.DataBean.ArticleBean articleBean = mArticleBeans.get(i);
        if (articleBean != null) {
